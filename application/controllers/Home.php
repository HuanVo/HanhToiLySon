...
//            $this->data['product'] = $product;
            ...
            // san pham ban chay
                $nput['limit'] = array(8,0);
                $nput['order'] = array('buyed','DESC');//DESC asc
                $product_bc = $this->product_model->get_list($nput);
                $this->data['product_bc'] = $product_bc;
            // san pham xem  nhiều   
                $nput['limit'] = array(8,0);
                $nput['order'] = array('view','DESC');//DESC asc
                $product_view = $this->product_model->get_list($nput);

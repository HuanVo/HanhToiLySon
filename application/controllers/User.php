<?php
    class User extends MY_Controller
    {
        ...
        function register(){
            ...
            if($this->input->post()){
                $this->form_validation->set_rules('fullname', 'Họ tên không được trống ', 'required' );
                $this->form_validation->set_rules('email', 'Email không được trống ', 'required|valid_email|callback_check_email' );
                ...
                $this->form_validation->set_rules('province', 'Nhập quận/huyện ', 'required' );
                $this->form_validation->set_rules('city', 'Chọn tỉnh thành ', 'required' );

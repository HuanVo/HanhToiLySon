            ...
            <div class="widget">
                ...
                <div class="tab_container">
                    <div class="tab_content pd0" id="tab1">
                        ...
                        <!-- weigh -->
                         <div class="formRow">
                            <label for="param_weigh" class="formLeft">
                                Khối lượng:
                            </label>
                            <div class="formRight">
                                <span class="oneFour">
                                    <input type="text" id="param_weigh" style="width:100px" name="weigh">
                                    <img src="<?php echo public_url(); ?>/admin/crown/images/icons/notifications/information.png" style="margin-bottom:-8px" title="Khối lượng hàng, Ví dụ: 500 g, >1k g, <700 g,..." class="tipS">
                                </span>
                                <span class="autocheck" name="weigh_autocheck"></span>

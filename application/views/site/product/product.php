...
<div id="content">
                ...
                <h3><?php echo 'Tất cả sản phẩm'.' ( <span style="color: red;">'.$total_rows.'</span> sản phẩm)'; ?></h3>
                <!--refine-->
                            ...
                            <div class="filter-right">
                                ...
                                <div class="limit">
                                    ...
                                    <select class="form-control" onchange="location = this.value;">
                                        <option value="<?php echo base_url();?>san-pham/10" <?php if(isset($limit))if($limit ==10) echo 'selected'; ?>>10</option>
                                        <option value="<?php echo base_url();?>san-pham/15" <?php if(isset($limit)) if($limit ==15) echo 'selected'; ?>>15</option>
                                        <option value="<?php echo base_url();?>san-pham/25" <?php if(isset($limit)) if($limit ==25) echo 'selected'; ?>>25</option>
                                        <option value="<?php echo base_url();?>san-pham/50" <?php if(isset($limit)) if($limit ==50) echo 'selected'; ?>>50</option>
                                        <option value="<?php echo base_url();?>san-pham/75" <?php if(isset($limit)) if($limit ==75) echo 'selected'; ?>>75</option>
                                        <option value="<?php echo base_url();?>san-pham/100" <?php if(isset($limit)) if($limit ==100) echo 'selected'; ?>>100</option>
                                    </select>
                                </div>
